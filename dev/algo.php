...
class algo
{
    ...
    public function startSimulation ($tmax, $echoooo)
    {
        ...
        while ($t < $tmax) {
            ...
            $interval = new DateInterval(
                    'PT' . (int) Utils::yearsToSeconds($r) . 'S'); // Cr�ation
                                                                                                // d'un
                                                                                                // interavalle
                                                                                                // de
                                                                                                // $r
    ...
    private function updateHorloge ($a_id)
    {
        ...
        if ($a->isDead) {
            ...
            // Si l'anemone n'avais pas d�ja ses taux a 0 dans l'horloge
            if (! $isAlreadyDead) {
     ...
     * Methode : Tire aléatoirement dans l'anemone un evenement en fonction des
     * taux
