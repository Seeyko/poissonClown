...
$populationOnceAWeek = Utils::lagonPopSorted_array('../output/lagonPopulationSortedOnceAWeek.ini');$i = 0;foreach ($populationOnceAWeek as $v){    $lagon1_line[$i] = array(         "y" => $v[2], "label" => $v[1]
    );    $lagon2_line[$i] = array(        "y" => $v[3], "label" => $v[1]    );       $lagon3_line[$i] = array(        "y" => $v[4], "label" => $v[1]    );       $lagon4_line[$i] = array(        "y" => $v[4], "label" => $v[1]    );       $lagon5_line[$i] = array(        "y" => $v[6], "label" => $v[1]    );       $lagon6_line[$i] = array(        "y" => $v[7], "label" => $v[1]    );       $lagon7_line[$i] = array(        "y" => $v[8], "label" => $v[1]    );       $i++;}
?>
<!DOCTYPE HTML>
<html>
<head>
